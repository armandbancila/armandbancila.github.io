! function (a) {
  ...
  return c.prototype.update = function () {
    ...
    this.g.beginPath(), this.g.fillStyle = this.particleColor, this.g.globalAlpha = .7, this.g.arc(this.x, this.y, 2.71828, 0, 2 * Math.PI), this.g.fill()
  }, b = function (a, b) {
    ...
    for (var a = 0; a < this.o.length; a++) {
      ...
      for (var b = this.o.length - 1; b > a; b--) {
        ...
        c > 120 || (this.g.beginPath(), this.g.strokeStyle = this.options.particleColor, this.g.globalAlpha = (120 - c) / 120, this.g.lineWidth = 1.0, this.g.moveTo(this.o[a].x, this.o[a].y), this.g.lineTo(this.o[b].x, this.o[b].y), this.g.stroke())
      }
    }
...
// Init after everything finishes loading
window.onload = function () {
  var canvasDiv = document.getElementById('particle-canvas');
  var options = {
    particleColor: '#458588'
    , background: '#16161d'
    , interactive: false
    , speed: 'slow'
    , density: 'high'
